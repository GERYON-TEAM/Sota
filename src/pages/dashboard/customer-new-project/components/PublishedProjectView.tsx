type PublishedProjectViewProps = {
  onGoToProjects: () => void
}

export default function PublishedProjectView({ onGoToProjects }: PublishedProjectViewProps) {
  return (
    <section className="customer-new-project-published">
      <div className="customer-new-project-published__content">
        ...
        <h2 className="customer-new-project-published__title">Вы опубликовали новый проект!</h2>
        <p className="customer-new-project-published__text">
          Теперь вы можете отслеживать его состояние в разделе &ldquo;Активные проекты&rdquo;
        </p>

        <button className="customer-new-project-published__button" type="button" onClick={onGoToProjects}>
