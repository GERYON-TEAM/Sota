...
export default function WorkspaceTools() {
  return (
    <div className="project-workspace__tools">
      <SearchInput />
      <button className="project-workspace__filter" type="button">
        <span className="project-workspace__filter-icon" aria-hidden="true">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
