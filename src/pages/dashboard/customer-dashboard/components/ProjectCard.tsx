...
export default function ProjectCard({ project }: ProjectCardProps) {
  const statusClass =
    project.role === 'Завершено'
      ? 'project-role--done'
      : project.role === 'В процессе'
        ? 'project-role--progress'
        : project.role === 'Опубликовано'
          ? 'project-role--published'
          : project.role === 'Черновик'
            ? 'project-role--draft'
            : ''
    ...
    <div className="project-frame">
      <div className="project-card">
        <div className="project-card__top">
          <div className={`project-role ${statusClass}`}>{project.role}</div>
          <button
        ...
        <div className="project-desc">{ellipsis(project.taskDesc, 140)}</div>
        ...
        <div className="project-metrics">
          ...
          <div className="project-metric">
            ...
            <span className="project-metric__value">{project.taskDate}</span>
          </div>
        </div>
